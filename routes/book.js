...
router.post('/', auth, multer, bookCtrl.createBook) // la route pour créer un nouveau livre en appelant la fonction createBook tout en appliquant les middlewares auth et multer
